...
def loadToCassandra():
    ...
    drop_table_cql = 'DROP TABLE IF EXISTS "yelp"."businesses";'
    create_table_cql = 'CREATE TABLE IF NOT EXISTS "yelp"."businesses" (\
                        "Cuisine" TEXT,\
                        "Name" TEXT,\
                        "Name" TEXT,\
                        "Rating" TEXT,\
    ...
    # time.sleep(5)
    CQLString = 'INSERT INTO "yelp"."businesses" JSON '
    msg_cnt = 0
